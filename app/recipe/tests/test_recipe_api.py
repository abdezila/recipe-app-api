...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """Test returieving a list of recipes."""
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning an existing tag when updatign a recipe."""
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_1 = Ingredient.objects.create(user = self.user, name = 'Papper')
...
class ImgaeUploadTests(TestCase):
